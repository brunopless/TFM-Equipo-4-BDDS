...
```{r}
formula <- price~floor+propertyType+size+exterior+rooms+bathrooms+latitude+longitude+status+newDevelopment+distancia_minima_banco+distancia_minima_starbucks+distancia_minima_atractivos+distancia_minima_buenasmigas+distancia_minima_clubesnocturnos+distancia_minima_mcdonalds+distancia_minima_metro+distancia_minima_parking+distancia_minima_parkingbici+distancia_minima_parques+distancia_minima_playa+distancia_minima_santagloria+distancia_minima_vivari+num_airbnbs_500+media_precios_airbnbs_500
```
